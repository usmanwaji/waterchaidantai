...
const SHELL_ASSETS = [
  ...
  'js/criteria.js?v=2','js/supabase-client.js?v=3','js/auth-ui.js','js/shelters_nwt.js','js/ddpm_risk_data.js','js/rivers.js','js/pwa.js','js/ui.js','js/views.js?v=2',
